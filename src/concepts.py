...
C = [
 ...
 # ---------- SELF ----------
 ("The Immortal Soul","self","grk",-380,"The self is a deathless soul, temporarily housed in the body.",["Plato"]),
 ("Substance Dualism","self","mod",1641,"Mind and body are two different substances; the thinking self is non-physical.",["Descartes"]),
 ...
 ("Behaviorist Mind","self","psy",1913,"Drop the inner self; study only observable behavior and conditioning.",["Watson","Skinner"]),
 ("Functionalism","self","ana",1967,"Mind is what mind does; mental states are functional roles, not stuff.",["Putnam"]),
